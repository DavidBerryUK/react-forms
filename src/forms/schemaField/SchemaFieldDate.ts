...
export default class SchemaFieldDate extends SchemaFieldBase implements ISchemaField {
  ...
  public static create(id: string, caption: string, fieldType: EnumFieldType): SchemaFieldDate {
    return new SchemaFieldDate(id, caption, fieldType);
  }

  public static createWithRule(id: string, caption: string, fieldType: EnumFieldType, rule: IRule): SchemaFieldDate {
    return new SchemaFieldDate(id, caption, fieldType, RuleGroup.create(rule));
  }

  public static createWithRuleGroup(id: string, caption: string, fieldType: EnumFieldType, ruleGroup: IRuleGroup): SchemaFieldDate {
    return new SchemaFieldDate(id, caption, fieldType, ruleGroup);
  }
  ...
  public static createWithRuleAndCondition(
    ...
    return new SchemaFieldDate(id, caption, fieldType, RuleGroup.createRuleAndCondition(rule, condition));
  }
  ...
  public static createWithRuleAndConditions(
    ...
    return new SchemaFieldDate(id, caption, fieldType, RuleGroup.createRuleAndConditions(rule, condition));
  }
  ...
  public static createWithRulesAndCondition(
    ...
    return new SchemaFieldDate(id, caption, fieldType, RuleGroup.createRulesAndCondition(rules, condition));
  }
  ...
  public static createWithRulesAndConditions(
    ...
    return new SchemaFieldDate(id, caption, fieldType, RuleGroup.createRulesAndConditions(rules, conditions));
  }

  public static createWithRules(id: string, caption: string, fieldType: EnumFieldType, rules: Array<IRule>): SchemaFieldDate {
    if (rules.length === 0) {
      return new SchemaFieldDate(id, caption, fieldType);
    }
    return new SchemaFieldDate(id, caption, fieldType, RuleGroup.createRules(rules));
  }

  public static createWithRuleGroups(id: string, caption: string, fieldType: EnumFieldType, ruleGroups: Array<IRuleGroup>) {
    const field = new SchemaFieldDate(id, caption, fieldType);
