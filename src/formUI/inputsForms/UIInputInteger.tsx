...
const UIInputInteger: React.FC<IInputProperties> = (props) => {
  ...
  const ensureCorrectFormat = () => {
    const formattedValue = TextNumberFormatter.formatInteger(field.valueAsString, props.allowBlankNumbers);
